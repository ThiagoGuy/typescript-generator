...
/* harmony import */ var _generator_setterGenerator__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./generator/setterGenerator */ "./src/app/generator/setterGenerator.ts");
/* harmony import */ var _generator_classGenerator__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./generator/classGenerator */ "./src/app/generator/classGenerator.ts");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.generate = function () {
        var jsonParsed;
        this.clearConsole();
        if (jsonParsed = _service_utils_service__WEBPACK_IMPORTED_MODULE_12__["UtilService"].parseJson(this.json)) {
            var generator = void 0;
            if (this.generatorType === _generator_enums_generatorTypes_enum__WEBPACK_IMPORTED_MODULE_8__["GeneratorTypesEnum"].SETTER) {
                generator = new _generator_setterGenerator__WEBPACK_IMPORTED_MODULE_13__["SetterGenerator"](this.options, this.writer);
            }
            else {
                generator = new _generator_classGenerator__WEBPACK_IMPORTED_MODULE_14__["ClassGenerator"](this.options, this.writer);
            }
            try {
            ...
            _service_alert_service__WEBPACK_IMPORTED_MODULE_7__["AlertService"].showError('Invalid JSON was detected.');
        }
...
/* harmony import */ var _service_utils_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../service/utils.service */ "./src/app/service/utils.service.ts");
/* harmony import */ var _service_alert_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../service/alert.service */ "./src/app/service/alert.service.ts");
/* harmony import */ var _models_class__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/class */ "./src/app/generator/models/class.ts");
/* harmony import */ var _models_import__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/import */ "./src/app/generator/models/import.ts");
/* harmony import */ var _models_arrayAttribute__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./models/arrayAttribute */ "./src/app/generator/models/arrayAttribute.ts");
/* harmony import */ var _models_attribute__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/attribute */ "./src/app/generator/models/attribute.ts");
/* harmony import */ var _enums_encryption_enum__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./enums/encryption.enum */ "./src/app/generator/enums/encryption.enum.ts");
/* harmony import */ var _enums_assignments_enum__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./enums/assignments.enum */ "./src/app/generator/enums/assignments.enum.ts");
/* harmony import */ var _models_content__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./models/content */ "./src/app/generator/models/content.ts");
...
var ClassGenerator = /** @class */ (function () {
    function ClassGenerator(options, writer) {
        if (!options) {
            _service_alert_service__WEBPACK_IMPORTED_MODULE_1__["AlertService"].showError('Options cannot be empty.');
        }
        if (!writer) {
            _service_alert_service__WEBPACK_IMPORTED_MODULE_1__["AlertService"].showError('The writer cannot be null.');
        }
    ...
    ClassGenerator.prototype.create = function (json, fieldName) {
        ...
        if (_service_utils_service__WEBPACK_IMPORTED_MODULE_0__["UtilService"].isBlank(fieldName)) {
            _service_alert_service__WEBPACK_IMPORTED_MODULE_1__["AlertService"].showError('Class name cannot be blank.');
        }
        var className = _service_utils_service__WEBPACK_IMPORTED_MODULE_0__["UtilService"].getClassName(fieldName);
        var clazz = new _models_class__WEBPACK_IMPORTED_MODULE_2__["Class"](className);
        ...
        for (var field in json) {
            if (_service_utils_service__WEBPACK_IMPORTED_MODULE_0__["UtilService"].isBlank(field)) {
                _service_alert_service__WEBPACK_IMPORTED_MODULE_1__["AlertService"].showError('Field name cannot be blank.');
            }
            var val = json[field];
            ...
            if (isFieldAnArray) {
                ...
                if (isFieldAnObject) {
                    clazz.imports.push(new _models_import__WEBPACK_IMPORTED_MODULE_3__["Import"](_service_utils_service__WEBPACK_IMPORTED_MODULE_0__["UtilService"].getClassName(field), "./" + field));
                    clazz.arrayAttributes.push(new _models_arrayAttribute__WEBPACK_IMPORTED_MODULE_4__["ArrayAttribute"](field, _service_utils_service__WEBPACK_IMPORTED_MODULE_0__["UtilService"].getClassName(field)));
                    this.create(val[0], field);
                }
                else {
                    clazz.arrayAttributes.push(new _models_arrayAttribute__WEBPACK_IMPORTED_MODULE_4__["ArrayAttribute"](field, fieldType));
                }
            }
            else {
                ...
                if (isFieldAnObject) {
                    clazz.imports.push(new _models_import__WEBPACK_IMPORTED_MODULE_3__["Import"](_service_utils_service__WEBPACK_IMPORTED_MODULE_0__["UtilService"].getClassName(field), "./" + field));
                    clazz.attributes.push(new _models_attribute__WEBPACK_IMPORTED_MODULE_5__["Attribute"](field, _service_utils_service__WEBPACK_IMPORTED_MODULE_0__["UtilService"].getClassName(field)));
                    this.create(val, field);
                }
                else {
                    var isEncrypted = _service_utils_service__WEBPACK_IMPORTED_MODULE_0__["UtilService"].isBase64(val);
                    if (this.options.encryption === _enums_encryption_enum__WEBPACK_IMPORTED_MODULE_6__["EncryptionEnum"].ENCRYPT && isEncrypted) {
                        clazz.attributes.push(new _models_attribute__WEBPACK_IMPORTED_MODULE_5__["Attribute"](field, fieldType, this.options.encryption));
                        if (!isEncryptionImportApplied && this.options.encryptionPath) {
                            clazz.imports.push(new _models_import__WEBPACK_IMPORTED_MODULE_3__["Import"](this.options.encryption, this.options.encryptionPath));
                            isEncryptionImportApplied = true;
                        }
                    }
                    else {
                        clazz.attributes.push(new _models_attribute__WEBPACK_IMPORTED_MODULE_5__["Attribute"](field, fieldType));
                    }
                }
            }
        }
    ...
    ClassGenerator.prototype.build = function () {
        ...
        this.classList.forEach(function (clazz) {
            ...
            if (_this.options.assignment === _enums_assignments_enum__WEBPACK_IMPORTED_MODULE_7__["AssignmentsEnum"].SETTER_METHOD) {
            ...
            _this.writer.writeLine();
            contents.push(new _models_content__WEBPACK_IMPORTED_MODULE_8__["Content"](clazz.className, _this.writer.toString()));
            _this.writer.reset();
        });
        return contents;
    };
...
/* harmony import */ var _service_alert_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../service/alert.service */ "./src/app/service/alert.service.ts");
/* harmony import */ var _models_instance__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/instance */ "./src/app/generator/models/instance.ts");
/* harmony import */ var _models_arrayInstance__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/arrayInstance */ "./src/app/generator/models/arrayInstance.ts");
/* harmony import */ var _models_arraySetter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/arraySetter */ "./src/app/generator/models/arraySetter.ts");
/* harmony import */ var _service_utils_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/utils.service */ "./src/app/service/utils.service.ts");
/* harmony import */ var _enums_assignments_enum__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./enums/assignments.enum */ "./src/app/generator/enums/assignments.enum.ts");
/* harmony import */ var _enums_question_enum__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./enums/question.enum */ "./src/app/generator/enums/question.enum.ts");
...
/* harmony import */ var _models_setter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./models/setter */ "./src/app/generator/models/setter.ts");
...
var SetterGenerator = /** @class */ (function () {
    function SetterGenerator(options, writer) {
        if (!options) {
            _service_alert_service__WEBPACK_IMPORTED_MODULE_0__["AlertService"].showError('Options cannot be empty.');
        }
        if (!writer) {
            _service_alert_service__WEBPACK_IMPORTED_MODULE_0__["AlertService"].showError('The writer cannot be null.');
        }
        this.options = options;
        this.writer = writer;
    ...
    SetterGenerator.prototype.create = function (json, fieldName, className) {
        ...
        if (_service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].isBlank(fieldName)) {
            _service_alert_service__WEBPACK_IMPORTED_MODULE_0__["AlertService"].showError('Field name cannot be blank.');
        }
        fieldName = _service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].fixFieldName(fieldName);
        className = className || _service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].getClassName(fieldName);
        var isArray = Array.isArray(json);
        var nextFieldName = this.memorizeNextFieldName(fieldName);
        if (isArray) {
            var fieldType = _service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].getType(json[0]);
            if (fieldType === 'object') {
                fieldType = className;
            }
            this.arrayInstances.push(new _models_arrayInstance__WEBPACK_IMPORTED_MODULE_2__["ArrayInstance"](fieldName, fieldType));
        }
        else {
            this.instances.push(new _models_instance__WEBPACK_IMPORTED_MODULE_1__["Instance"](nextFieldName, className));
        }
        for (var field in json) {
            if (_service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].isBlank(field)) {
                _service_alert_service__WEBPACK_IMPORTED_MODULE_0__["AlertService"].showError('Field name cannot be blank.');
            }
            var val = json[field];
            var isFieldAnObject = _service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].isObject(val);
            var isFieldAnArray = Array.isArray(val);
            if (this.options.arrayInstantiation === _enums_question_enum__WEBPACK_IMPORTED_MODULE_6__["QuestionEnum"].NO && isFieldAnArray)
                continue;
            field = _service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].fixFieldName(field);
            if (isArray) {
                if (isFieldAnObject) {
                    var name_1 = _service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].getListFieldName(fieldName, val);
                    this.arrayInstanceSetters.push(new _models_arraySetter__WEBPACK_IMPORTED_MODULE_3__["ArraySetter"](fieldName, this.generateNextFieldName(name_1)));
                    this.create(val, name_1, _service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].getClassName(name_1));
                }
                else {
                    this.arraySetters.push(new _models_arraySetter__WEBPACK_IMPORTED_MODULE_3__["ArraySetter"](nextFieldName, _service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].fixValue(val, this.options.stringDataTypeOnly === _enums_question_enum__WEBPACK_IMPORTED_MODULE_6__["QuestionEnum"].YES)));
                }
            }
            else {
                if (isFieldAnObject) {
                    var name_2 = _service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].getListFieldName(field, val);
                    this.instanceSetters.push(new _models_setter__WEBPACK_IMPORTED_MODULE_8__["Setter"](nextFieldName, field, name_2));
                    this.create(val, name_2, _service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].getClassName(field));
                }
                else {
                    if (this.options.emptyString === _enums_question_enum__WEBPACK_IMPORTED_MODULE_6__["QuestionEnum"].YES || val) {
                        this.setters.push(new _models_setter__WEBPACK_IMPORTED_MODULE_8__["Setter"](nextFieldName, field, _service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].fixValue(val, this.options.stringDataTypeOnly === _enums_question_enum__WEBPACK_IMPORTED_MODULE_6__["QuestionEnum"].YES)));
                    }
                }
            }
        }
    ...
    SetterGenerator.prototype.build = function () {
        ...
        if (this.options.assignment === _enums_assignments_enum__WEBPACK_IMPORTED_MODULE_5__["AssignmentsEnum"].SETTER_METHOD) {
        ...
        if (!_service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].isEmpty(this.instanceSetters))
            this.writer.writeLine();
        this.arrayInstanceSetters.forEach(function (ais) { return _this.writer.writeArraySetter(ais); });
        if (!_service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].isEmpty(this.arrayInstanceSetters))
            this.writer.writeLine();
        this.arraySetters.forEach(function (as) { return _this.writer.writeArraySetter(as); });
        if (!_service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].isEmpty(this.arraySetters))
            this.writer.writeLine();
        if (this.options.assignment === _enums_assignments_enum__WEBPACK_IMPORTED_MODULE_5__["AssignmentsEnum"].SETTER_METHOD) {
        ...
        contents.push(new _models_content__WEBPACK_IMPORTED_MODULE_7__["Content"]('Setters', this.writer.toString()));
        this.writer.reset();
        return contents;
    };
    ...
    SetterGenerator.prototype.generateNextFieldName = function (fieldName) {
        ...
        if (this.fieldNameMap.has(fieldName)) {
            ...
            if (fieldCounter = _service_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"].getNumberFromString(fieldNameFromMap)) {
...
/* harmony import */ var _writer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./writer */ "./src/app/generator/writers/writer.ts");
/* harmony import */ var _service_utils_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../service/utils.service */ "./src/app/service/utils.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
module.exports = __webpack_require__(/*! C:\GiTDevelopment\project\angular\typescript-generator\src\main.ts */"./src/main.ts");
